  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        <h1 className="text-xl font-display font-bold text-primary text-glow">Acesso do Aluno</h1>
        ...
        <a href="/labdoselementos/auth" className="text-xs text-muted-foreground hover:text-primary transition-colors block">
          ← Voltar
        </a>
      </div>
    </div>
